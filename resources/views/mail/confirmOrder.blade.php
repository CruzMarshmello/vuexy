...
<body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; --bg-opacity: 1; background-color: #eceff1; background-color: rgba(236, 239, 241, var(--bg-opacity));">
    <div style="display: none;">Thank your for your order</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p style="margin: 0 0 24px;">
                                                Your can track the goods or download invoice documents and tax invoice at the attached link
                                            </p>
                                            <p style="margin: 0 0 24px;">
                                                If you did not order to Vuexy, please ignore this email or contact us at
