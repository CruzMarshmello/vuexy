...
<div class="row">
    <div class="col-md-12 col-12">
        <form class="form form-vertical" action="{{ route('admin.filters.store') }}" method="post">
            @csrf
            <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                ">
                                    ...
                                    @error ('english_name')
                                        is-invalid
                                    @enderror
                                    " name="english_name" placeholder="Colour" value="{{ old('english_name') }}" />
                                </div>
                                @error ('english_name')
                            ...
                            <div class="form-group">
                                ...
                                ">
                                    ...
                                    @error ('thai_name')
                                        is-invalid
                                    @enderror
                                    " name="thai_name" placeholder="สี" value="{{ old('thai_name') }}" />
                                </div>
                                @error ('thai_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" name="options[0][english_name]" placeholder="Purple" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" name="options[0][thai_name]" placeholder="ม่วง" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" class="form-control" name="options[0][sort_order]" placeholder="0" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1 col-12">
                                <div class="form-group">
                                    <button class="btn btn-outline-danger text-nowrap" type="button" id="btn-delete" data-id="0">
                                        <i data-feather="x"></i>
                                    </button>
                                </div>
                            </div>
