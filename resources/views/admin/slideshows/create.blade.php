...
<div class="row">
    <div class="col-md-12 col-12">
        <form class="form form-vertical" action="{{ route('admin.slideshows.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('english_title')
                                                        is-invalid
                                                    @enderror
                                                    " name="english_title" placeholder="Amazing Outlet !!" value="{{ old('english_title') }}" />
                                                </div>
                                                @error ('english_title')
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('english_url')
                                                        is-invalid
                                                    @enderror
                                                    " name="english_url" placeholder="{{ env('APP_URL') }}/amazing-outlet" value="{{ old('english_url') }}" />
                                                </div>
                                                @error ('english_url')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('thai_title')
                                                        is-invalid
                                                    @enderror
                                                    " name="thai_title" placeholder="ตื่นตาตื่นใจกับแฟชั่น !!" value="{{ old('thai_title') }}" />
                                                </div>
                                                @error ('thai_title')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('thai_url')
                                                        is-invalid
                                                    @enderror
                                                    " name="thai_url" placeholder="{{ env('APP_URL') }}/ตื่นตาตื่นกับ-แฟชั่น" value="{{ old('thai_url') }}" />
                                                </div>
                                                @error ('thai_url')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
