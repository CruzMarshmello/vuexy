...
<div class="row">
    <div class="col-md-12 col-12">
        <form class="form form-vertical" action="{{ route('admin.products.update',['id' => $product->id]) }}" method="post">
            @csrf
            @method('put')
                ...
                <div class="card-body">
                    <div class="tab-content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('english_name')
                                                        is-invalid
                                                    @enderror
                                                    " name="english_name" placeholder="Classic Superstate Polo" value="{{ old('english_name', $product->locale('en')->name) }}" />
                                                </div>
                                                @error ('english_name')
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('english_slug')
                                                        is-invalid
                                                    @enderror
                                                    " name="english_slug" placeholder="classic-superstate-polo" value="{{ old('english_slug', $product->locale('en')->slug) }}" />
                                                </div>
                                                @error ('english_slug')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div id="full-wrapper">
                                                <div id="full-container">
                                                    ...
                                                    <div class="english-description">
                                                        {!! old('english_description', $product->locale('en')->description) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('english_meta_title')
                                                        is-invalid
                                                    @enderror
                                                    " name="english_meta_title" placeholder="Classic Superstate" value="{{ old('english_meta_title', $product->locale('en')->meta_title) }}" />
                                                </div>
                                                @error ('english_meta_title')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" name="english_meta_keyword" placeholder="classic,polo,men" value="{{ old('english_meta_keyword', $product->locale('en')->meta_keyword) }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="8" name="english_meta_description" placeholder="Description">{{ old('english_meta_description', $product->locale('en')->meta_description) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('thai_name')
                                                        is-invalid
                                                    @enderror
                                                    " name="thai_name" placeholder="เสื้อโปโล Classic Superstate" value="{{ old('thai_name', $product->locale('th')->name) }}" />
                                                </div>
                                                @error ('thai_name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('thai_slug')
                                                        is-invalid
                                                    @enderror
                                                    " name="thai_slug" placeholder="เสื้อโปโล-classic-superstate" value="{{ old('thai_slug', $product->locale('th')->slug) }}" />
                                                </div>
                                                @error ('thai_slug')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div id="full-wrapper">
                                                <div id="full-container">
                                                    ...
                                                    <div class="thai-description">
                                                        {!! old('thai_description', $product->locale('th')->description) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('thai_meta_title')
                                                        is-invalid
                                                    @enderror
                                                    " name="thai_meta_title" placeholder="เสื้อโปโล Classic Superstate" value="{{ old('thai_meta_title', $product->locale('th')->meta_title) }}" />
                                                </div>
                                                @error ('thai_meta_title')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" name="thai_meta_keyword" placeholder="เสื้อโปโล,classic,ผู้ชาย" value="{{ old('thai_meta_keyword', $product->locale('th')->meta_keyword) }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label>Meta Description</label>
                                                <textarea class="form-control" rows="8" name="thai_meta_description" placeholder="รายละเอียด">{{ old('thai_meta_description', $product->locale('th')->meta_description) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" name="sku" placeholder="000SKU123" value="{{ old('sku', $product->sku) }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        ">
                                            ...
                                            @error ('quantity')
                                                is-invalid
                                            @enderror
                                            " name="quantity" placeholder="0" value="{{ old('quantity', $product->quantity) }}" />
                                        </div>
                                        @error ('quantity')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        ">
                                            ...
                                            @error ('price')
                                                is-invalid
                                            @enderror
                                            " name="price" placeholder="0" value="{{ old('price', $product->price) }}" />
                                        </div>
                                        @error ('price')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="tab-pane" id="option" role="tabpanel" aria-labelledby="option-tab" aria-expanded="false">
                            ...
                            <input type="hidden" name="options" value="without">
                            @if (old('options') != 'without')
                            @if (old('options'))
                                    ...
                                    <div class="col-md-3 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="options[{{ $key }}][sku]" placeholder="000SKU123" value="{{ $option->sku }}" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="options[{{ $key }}][english_name]" placeholder="M" value="{{ $option->locale('en')->name }}" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="options[{{ $key }}][thai_name]" placeholder="เล็ก" value="{{ $option->locale('th')->name }}" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="number" class="form-control" name="options[{{ $key }}][quantity]" placeholder="0" value="{{ $option->quantity }}" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="number" class="form-control" name="options[{{ $key }}][price]" placeholder="0" value="{{ $option->price }}" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mb-1">
                                    ...
                                    <select class="select2 form-control" name="filters[]" multiple>
                                        ...
                                        <optgroup label="{{ $filter->locale('en')->name }}">
                                            ...
                                            @else
                                            {{ ($product->hasFilter($option->id))? 'selected' : '' }}
                                            @endif
                                            >
                                    ...
                                    <div class="form-group">
                                        ...
                                        ">
                                            ...
                                            @error ('daterange')
                                                is-invalid
                                            @enderror
                                            " name="daterange" placeholder="YYYY-MM-DD to YYYY-MM-DD" value="
                                            @if (old('daterange'))
                                                {{ old('daterange') }}
                                            @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        ">
                                            ...
                                            @error ('percentage')
                                                is-invalid
                                            @enderror
                                            " name="percentage" placeholder="0" value="{{ old('percentage', $product->percentage) }}" />
                                        </div>
                                        @error ('percentage')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="tab-pane" id="image" role="tabpanel" aria-labelledby="image-tab" aria-expanded="false">
                            ...
                            <div class="row">
                                <input type="hidden" name="paths" value="without">
                                @if (old('paths') != 'without')
                                @if (old('paths'))
                                ...
                                <div class="col-md-3 mb-1" id="image-{{ $productImage->id }}">
                                    <img class="rounded img-fluid" src="{{ $productImage->path }}">
                                    <input type="hidden" name="images[]" value="{{ $productImage->id }}">
                                    <input type="hidden" name="paths[]" value="{{ $productImage->path }}">
                                    <button type="button" class="btn btn-block btn-flat-danger" id="btn-image-delete" data-id="{{ $productImage->id }}">Delete</button>
                                </div>
                                @endforeach
                                @endif
                                @endif
...
<script type="text/javascript">
    $(function() {
        ...
        $('#option').on('click', '#btn-option-plus', function() {
            ...
            div += '</div>';
            div += '<input type="hidden" name="options[' + i + '][id]"/>';
