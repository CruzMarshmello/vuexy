...
<div class="main-menu menu-fixed {{($configData['theme'] === 'dark') ? 'menu-dark' : 'menu-light'}} menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @php
            echo $name = Str::lower($menu->name);
            @endphp
            @if (!Auth::user()->hasPermission('create '.$name) && !Auth::user()->hasPermission('read '.$name) && !Auth::user()->hasPermission('update '.$name) && !Auth::user()->hasPermission('delete '.$name))
                disabled
            @endif
            ">
