    ...
    <div class="auth-inner row m-0">
        ...
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                <form class="auth-reset-password-form mt-2" action="{{ route('admin.authentications.setPassword') }}" method="POST">
                    @csrf
                ...
                <p class="text-center mt-2">
                    <a href="{{ route('admin.authentications.index') }}">
                        <i data-feather="chevron-left"></i> Back to Sign In
                    </a>
                </p>
            </div>
        </div>
