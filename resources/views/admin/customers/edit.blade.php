...
<div class="row">
    <div class="col-md-12 col-12">
        <form class="form form-vertical" action="{{ route('admin.customers.update',['id' => $user->id]) }}" method="post">
            @method('put')
            @csrf
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="address-book" role="tabpanel" aria-labelledby="address-book-tab" aria-expanded="false">
                            ...
                            <input type="hidden" name="address_books" value="without">
                            @if (old('address_books') != 'without')
                                    ...
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            ">
                                                ...
                                                <input type="hidden" name="address_books[{{ $key }}][id]" value="{{ old('address_books')[$key]['id'] }}">
                                                <input type="text" class="form-control
                                                @error ('address_books.'.$key.'.location')
                                                    is-invalid
                                                @enderror
                                    ...
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="hidden" name="address_books[{{ $key }}][id]" value="{{ $addressBook->id }}">
                                                <input type="text" class="form-control" name="address_books[{{ $key }}][location]" placeholder="My Home" value="{{ $addressBook->location }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="address_books[{{ $key }}][full_name]" placeholder="John Doe" value="{{ $addressBook->full_name }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="address_books[{{ $key }}][address_1]" placeholder="123 Phiboonsongkharm Rd." value="{{ $addressBook->address_1 }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="address_books[{{ $key }}][address_2]" placeholder="Optional" value="{{ $addressBook->address_2 }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="address_books[{{ $key }}][sub_district]" placeholder="Bangkharn" value="{{ $addressBook->sub_district }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="address_books[{{ $key }}][district]" placeholder="Mueng" value="{{ $addressBook->district }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="address_books[{{ $key }}][province]" placeholder="Nonthaburi" value="{{ $addressBook->province }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="number" class="form-control" name="address_books[{{ $key }}][postal_code]" placeholder="11000" value="{{ $addressBook->postal_code }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="address_books[{{ $key }}][country]" placeholder="Thailand" value="{{ $addressBook->country }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-12 align-self-start">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" class="form-control" name="address_books[{{ $key }}][telephone]" placeholder="012-345-6789" value="{{ $addressBook->telephone }}" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-1 col-12 align-self-center">
...
<script type="text/javascript">
    $(function() {
        $('#address-book').on('click', '#btn-address-book-plus', function() {
            ...
            div += '</div>';
            div += '<input type="hidden" name="address_books[' + i + '][id]"/>';
