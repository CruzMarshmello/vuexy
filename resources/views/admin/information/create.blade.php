...
@section('title', 'Information Create')
...
<div class="row">
    <div class="col-md-12 col-12">
        <form class="form form-vertical" action="{{ route('admin.information.store') }}" method="post" enctype="multipart/form-data">
            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('english_title')
                                                        is-invalid
                                                    @enderror
                                                    " name="english_title" placeholder="Terms and Conditions" value="{{ old('english_title') }}" />
                                                </div>
                                                @error ('english_title')
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('english_slug')
                                                        is-invalid
                                                    @enderror
                                                    " name="english_slug" placeholder="term-and-conditions" value="{{ old('english_slug') }}" />
                                                </div>
                                                @error ('english_slug')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('english_meta_title')
                                                        is-invalid
                                                    @enderror
                                                    " name="english_meta_title" placeholder="Terms and Conditions" value="{{ old('english_meta_title') }}" />
                                                </div>
                                                @error ('english_meta_title')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" name="english_meta_keyword" placeholder="Terms,Conditions" value="{{ old('english_meta_keyword') }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('thai_title')
                                                        is-invalid
                                                    @enderror
                                                    " name="thai_title" placeholder="ข้อกำหนด และ เงื่อนไข" value="{{ old('thai_title') }}" />
                                                </div>
                                                @error ('thai_title')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('thai_slug')
                                                        is-invalid
                                                    @enderror
                                                    " name="thai_slug" placeholder="ข้อกำหนด-และ-เงื่อนไข" value="{{ old('thai_slug') }}" />
                                                </div>
                                                @error ('thai_slug')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                ">
                                                    ...
                                                    @error ('thai_meta_title')
                                                        is-invalid
                                                    @enderror
                                                    " name="thai_meta_title" placeholder="ข้อกำหนด และ เงื่อนไข" value="{{ old('thai_meta_title') }}" />
                                                </div>
                                                @error ('thai_meta_title')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" name="thai_meta_keyword" placeholder="ข้อกำหนด,เงื่อนไข" value="{{ old('thai_meta_keyword') }}" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
